...
- (void)_tabBarInit {
    ...
    ((void(*)(id, SEL, UIFont*))impl)(self, selector, [UI7Font systemFontOfSize:10.0 attribute:UI7FontAttributeLight]);
    ...
    selector = NSSelectorFromString(name);
    impl = class_getMethodImplementation(self.class, selector);
    ((void(*)(id, SEL, UIColor*, UIColor*))impl)(self, selector, [UIColor grayColor], self.tintColor);
}
