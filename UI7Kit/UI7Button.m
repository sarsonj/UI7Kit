...
- (id)_UIRoundedRectButton_initWithCoder:(NSCoder *)aDecoder {
    ...
    self = ((UI7Button*(*)(id, SEL, NSCoder *))[UI7Button methodImplementationForSelector:@selector(initWithCoder:)])(self, _cmd, aDecoder);
    return self;
}
...
- (void)setTitleColor:(UIColor *)color forState:(UIControlState)state {
    ...
    ((void(*)(id, SEL, UIColor*, UIControlState))impl)(self, selector, color, state);
}
